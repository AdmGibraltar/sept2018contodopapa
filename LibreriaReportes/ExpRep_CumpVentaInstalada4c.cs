namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_CumpVentaInstalada4c: Telerik.Reporting.Report
    {
        public ExpRep_CumpVentaInstalada4c()
        {
            /// <summary>
        ...
        private void Rep_CumpVentaInstalada4c_NeedDataSource(object sender, EventArgs e)
        {
            try
            {              
        ...
        private void subReport1_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.expSubCumpVentaC41.Id_Emp = this.ReportParameters["Id_Emp"].Value.ToString();
            this.expSubCumpVentaC41.Id_Cd = this.ReportParameters["Id_Cd"].Value.ToString();
            this.expSubCumpVentaC41.Semana = this.ReportParameters["Semana"].Value.ToString();
            this.expSubCumpVentaC41.Id_Cte = ((DataRow)reporteBase.DataObject.RawData).ItemArray[4].ToString();
            this.expSubCumpVentaC41.Id_Ter = ((DataRow)reporteBase.DataObject.RawData).ItemArray[0].ToString();
            this.expSubCumpVentaC41.Id_Prd = this.ReportParameters["Sproducto"].Value.ToString();

            this.expSubCumpVentaC41.Conexion = this.ReportParameters["Emp_Cnx"].Value.ToString();
        }
