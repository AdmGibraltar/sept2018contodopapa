namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_CumpVentaInstalada2a: Telerik.Reporting.Report
    {
        public Rep_CumpVentaInstalada2a()
        {
            /// <summary>
        ...
        private void Rep_CumpVentaInstalada2a_NeedDataSource(object sender, EventArgs e)
        {
            try
            {                               
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Formato"].Value = this.ReportParameters["Formato"].Value;
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Detalle"].Value = 1;// this.ReportParameters["Reporte1"].Value;
