namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_SerAmortizacionSisP: Telerik.Reporting.Report
    {
        public ExpRep_SerAmortizacionSisP()
        {
            /// <summary>
        ...
        private void Rep_SerAmortizacionSisP_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Representante"].Value = this.ReportParameters["Representante"].Value;
