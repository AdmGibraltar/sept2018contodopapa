namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepPrecioConvenioLista : Telerik.Reporting.Report
    {
        public RepPrecioConvenioLista()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepPrecioConvenioLista_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
