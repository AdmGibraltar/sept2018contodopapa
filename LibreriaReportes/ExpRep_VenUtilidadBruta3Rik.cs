namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_VenUtilidadBruta3Rik : Telerik.Reporting.Report
    {
        public ExpRep_VenUtilidadBruta3Rik()
        {
            /// <summary>
        ...
        private void Rep_InvValorizacionInventarios_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.sqlDataAdapter1.SelectCommand.Parameters["@Salida"].Value = 5;
