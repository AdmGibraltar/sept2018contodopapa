namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_CargosPdtesxRik: Telerik.Reporting.Report
    {
        static double saldo_anterior = 0;
        static int Id_cliente = 0;
        static int Id_territorio = 0;

        public Rep_CargosPdtesxRik()
        {
            /// <summary>
        ...
        private void Rep_CargosPdtesxRik1_NeedDataSource(object sender, EventArgs e)
        {
            try 
            {
                saldo_anterior = 0;
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@agrupador"].Value = this.ReportParameters["agrupador"].Value;  //--2
