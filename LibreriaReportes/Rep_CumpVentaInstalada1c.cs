namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_CumpVentaInstalada1c: Telerik.Reporting.Report
    {
        public Rep_CumpVentaInstalada1c()
        {
            /// <summary>
        ...
        private void Rep_CumpVentaInstalada1c_NeedDataSource(object sender, EventArgs e)
        {
            try
            {                               
        ...
        private void subReport_1_NeedDataSource(object sender, EventArgs e)
        {
            Telerik.Reporting.Processing.ReportItemBase reporteBase = (Telerik.Reporting.Processing.ReportItemBase)sender;
            this.subCumpVentaC11.Id_Emp = this.ReportParameters["Id_Emp"].Value.ToString();
            this.subCumpVentaC11.Id_Cd = this.ReportParameters["Id_Cd"].Value.ToString();
            this.subCumpVentaC11.Semana = this.ReportParameters["Semana"].Value.ToString();
            this.subCumpVentaC11.Id_Cte = ((DataRow)reporteBase.DataObject.RawData).ItemArray[4].ToString();
            this.subCumpVentaC11.Id_Ter = ((DataRow)reporteBase.DataObject.RawData).ItemArray[0].ToString();
            this.subCumpVentaC11.Id_Prd = this.ReportParameters["Sproducto"].Value.ToString(); 

            this.subCumpVentaC11.Conexion = this.ReportParameters["Emp_Cnx"].Value.ToString();
        }
        ...
        private void subReport1_ItemDataBound(object sender, EventArgs e)
        {
            ...
            //subReport.Visible = report.ChildElements.Find("DetailSection1", True).Length > 0
