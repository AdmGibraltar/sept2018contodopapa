namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ResumenCartera_SW : Telerik.Reporting.Report
    {
        public ResumenCartera_SW()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCobEstCarteraDetalle_SW_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
