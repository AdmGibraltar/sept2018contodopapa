namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_CargosPdtesxTer2: Telerik.Reporting.Report
    { 
        static double saldo_anterior = 0;
        static int Id_cliente = 0;
        static int Id_territorio = 0;

        public Rep_CargosPdtesxTer2()
        {
            /// <summary>
        ...
        private void Rep_CargosPdtesxTer2_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                saldo_anterior = 0;
