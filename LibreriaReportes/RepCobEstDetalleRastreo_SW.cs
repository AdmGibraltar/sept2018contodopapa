namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCobEstDetalleRastreo_SW : Telerik.Reporting.Report
    {
        public RepCobEstDetalleRastreo_SW()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepCobEstDetalleRastreo_SW_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
