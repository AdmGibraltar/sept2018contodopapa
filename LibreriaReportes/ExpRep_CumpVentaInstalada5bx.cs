namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_CumpVentaInstalada5bx : Telerik.Reporting.Report
    {
        public ExpRep_CumpVentaInstalada5bx()
        {
            /// <summary>
        ...
        private void Rep_CumpVentaInstalada3bx_NeedDataSource(object sender, EventArgs e)
        {
            try
            {              
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@SubTipo"].Value = "X"; 
