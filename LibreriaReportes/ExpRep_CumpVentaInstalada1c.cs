namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_CumpVentaInstalada1c: Telerik.Reporting.Report
    {
        public ExpRep_CumpVentaInstalada1c()
        {
            /// <summary>
        ...
        private void subReport_1_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.expSubCumpVentaC11.Id_Emp = this.ReportParameters["Id_Emp"].Value.ToString();
            this.expSubCumpVentaC11.Id_Cd = this.ReportParameters["Id_Cd"].Value.ToString();
            this.expSubCumpVentaC11.Semana = this.ReportParameters["Semana"].Value.ToString();
            this.expSubCumpVentaC11.Id_Cte = ((DataRow)reporteBase.DataObject.RawData).ItemArray[4].ToString();
            this.expSubCumpVentaC11.Id_Ter = ((DataRow)reporteBase.DataObject.RawData).ItemArray[0].ToString();
            this.expSubCumpVentaC11.Id_Prd = this.ReportParameters["Sproducto"].Value.ToString();

            this.expSubCumpVentaC11.Conexion = this.ReportParameters["Emp_Cnx"].Value.ToString();
        }
