namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepCumplimientoVIDet_Pdcto : Telerik.Reporting.Report
    {
        public RepCumplimientoVIDet_Pdcto()
        {
            /// <summary>
        ...
        private void RepCumplimientoVIDet_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Id_Prd"].Value = rptq.Parameters["Id_Prd"].Value;
