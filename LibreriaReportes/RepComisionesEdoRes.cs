namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepComisionesEdoRes : Telerik.Reporting.Report
    {
        public RepComisionesEdoRes()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepComisionesEdoRes_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Reporte"].Value = 3;
