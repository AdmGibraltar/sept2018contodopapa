namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRepCobCarteraClientes1bx : Telerik.Reporting.Report
    {
        public ExpRepCobCarteraClientes1bx()
        {
            /// <summary>
        ...
        private void RepCobCarteraClientes1bx_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
