namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpSubCumpVentaC4 : Telerik.Reporting.Report
    {
        public ExpSubCumpVentaC4()
        {
            /// <summary>
        ...
        private void SubCumpVentaC4_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                //para detalle de venta instalada.. agregar subreporte con tipo = 3;
                this.sqlDataAdapter1.SelectCommand.Parameters["@Tipo"].Value = "4";// venta autorizada
