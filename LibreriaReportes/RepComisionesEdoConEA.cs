namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepComisionesEdoConEA : Telerik.Reporting.Report
    {
        public RepComisionesEdoConEA()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepComisionesEdoConEA_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Reporte"].Value = 4;
