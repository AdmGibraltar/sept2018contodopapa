namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_SerImproductivos2 : Telerik.Reporting.Report
    {
        public Rep_SerImproductivos2()
        {
            /// <summary>
        ...
        private void Rep_SerImproductivos2_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@DetalladoxProducto"].Value = 0;
        ...
        private void subReport1_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.subImproductividad1.Id_Emp = this.ReportParameters["Id_Emp"].Value.ToString();
            this.subImproductividad1.Id_Cd = this.ReportParameters["Id_Cd"].Value.ToString();
            this.subImproductividad1.Id_Spo = ((DataRow)reporteBase.DataObject.RawData).ItemArray[8].ToString();
            this.subImproductividad1.Id_Cte = ((DataRow)reporteBase.DataObject.RawData).ItemArray[4].ToString();
            this.subImproductividad1.Id_Ter = ((DataRow)reporteBase.DataObject.RawData).ItemArray[0].ToString();
            this.subImproductividad1.Conexion = this.ReportParameters["Conexion"].Value.ToString();
        }
