namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepComisionesEdoCon : Telerik.Reporting.Report
    {
        public RepComisionesEdoCon()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepComisionesEdoCon_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
