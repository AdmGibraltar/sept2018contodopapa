namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class RepComisionesCob : Telerik.Reporting.Report
    {
        public RepComisionesCob()
        {
            try
            {
                InitializeComponent();
        ...
        private void RepComisionesCob_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Reporte"].Value = 1;
