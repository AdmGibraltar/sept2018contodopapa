namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpSubCumpVentaC : Telerik.Reporting.Report
    {
        public ExpSubCumpVentaC()
        {
            /// <summary>
        ...
        private void SubCumpVentaC_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Tipo"].Value = "3";//VENTA INSTALADA
