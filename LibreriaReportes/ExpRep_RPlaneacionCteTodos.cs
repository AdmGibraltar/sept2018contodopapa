namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_RPlaneacionCteTodos : Telerik.Reporting.Report
    {
        public ExpRep_RPlaneacionCteTodos()
        {
            /// <summary>
        ...
        private void ExpRep_RPlaneacionCteTodos_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
