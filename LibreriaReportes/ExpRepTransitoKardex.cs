namespace LibreriaReportes
{
    ...
    /// <summary>
    /// Summary description for RepTransitoKardex.
    /// </summary>
    public partial class ExpRepTransitoKardex : Telerik.Reporting.Report
    {
        public ExpRepTransitoKardex()
        {
            /// <summary>
        ...
        private void RepTransitoKardex_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Tm_Tipo"].Value = this.ReportParameters["Tm_Tipo"].Value;
