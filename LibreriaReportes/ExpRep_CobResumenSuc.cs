namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_CobResumenSuc : Telerik.Reporting.Report
    {
        public ExpRep_CobResumenSuc()
        {
            /// <summary>
        ...
        private void Rep_CobResumenSuc2_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
