namespace LibreriaReportes
{
    ...
    /// <summary>
    /// Summary description for spRep_CobRotacionCarteraF1.
    /// </summary>
    public partial class spRep_CobRotacionCarteraF2 : Telerik.Reporting.Report
    {
        public spRep_CobRotacionCarteraF2()
        {
            /// <summary>
        ...
        private void spRep_CobRotacionCarteraF2_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Agrupado"].Value = 2;
