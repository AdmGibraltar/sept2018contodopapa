namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpSubCumpVentaC2_1 : Telerik.Reporting.Report
    {
        public ExpSubCumpVentaC2_1()
        {
            /// <summary>
        ...
        private void SubCumpVentaC2_1_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
               ...
               // this.sqlDataAdapter1.SelectCommand.Parameters["@RIK"].Value = this.Id_Rik;
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Tipo"].Value = "1";//VENTA NUEVA
