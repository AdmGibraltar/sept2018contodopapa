namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_CumpVentaInstalada4c: Telerik.Reporting.Report
    {
        public Rep_CumpVentaInstalada4c()
        {
            /// <summary>
        ...
        private void subReport1_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.subCumpVentaC41.Id_Emp = this.ReportParameters["Id_Emp"].Value.ToString();
            this.subCumpVentaC41.Id_Cd = this.ReportParameters["Id_Cd"].Value.ToString();
            this.subCumpVentaC41.Semana = this.ReportParameters["Semana"].Value.ToString();
            this.subCumpVentaC41.Id_Cte = ((DataRow)reporteBase.DataObject.RawData).ItemArray[4].ToString();
            this.subCumpVentaC41.Id_Ter = ((DataRow)reporteBase.DataObject.RawData).ItemArray[0].ToString();
            this.subCumpVentaC41.Id_Prd = this.ReportParameters["Sproducto"].Value.ToString();

            this.subCumpVentaC41.Conexion = this.ReportParameters["Emp_Cnx"].Value.ToString();
        }
