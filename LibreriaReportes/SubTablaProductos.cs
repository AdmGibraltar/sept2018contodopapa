namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class SubTablaProductos : Telerik.Reporting.Report
    {
        public SubTablaProductos()
        {
            /// <summary>
        ...
        private void SubTablaProductos_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
