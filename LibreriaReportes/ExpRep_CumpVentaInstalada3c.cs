namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_CumpVentaInstalada3c: Telerik.Reporting.Report
    {
        public ExpRep_CumpVentaInstalada3c()
        {
            /// <summary>
        ...
        private void subReport1_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.expSubCumpVentaC1.Id_Emp = this.ReportParameters["Id_Emp"].Value.ToString();
            this.expSubCumpVentaC1.Id_Cd = this.ReportParameters["Id_Cd"].Value.ToString();
            this.expSubCumpVentaC1.Semana = this.ReportParameters["Semana"].Value.ToString();
            this.expSubCumpVentaC1.Id_Cte = ((DataRow)reporteBase.DataObject.RawData).ItemArray[4].ToString();
            this.expSubCumpVentaC1.Id_Ter = ((DataRow)reporteBase.DataObject.RawData).ItemArray[0].ToString();
            this.expSubCumpVentaC1.Id_Prd = this.ReportParameters["Sproducto"].Value.ToString();

            this.expSubCumpVentaC1.Conexion = this.ReportParameters["Emp_Cnx"].Value.ToString();
        }
