namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRepCobCarteraClientes1ax : Telerik.Reporting.Report
    {
        public ExpRepCobCarteraClientes1ax()
        {
            /// <summary>
        ...
        private void RepCobCarteraClientes1ax_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
