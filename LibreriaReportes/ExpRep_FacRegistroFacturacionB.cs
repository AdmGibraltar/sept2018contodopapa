namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_FacRegistroFacturacionB : Telerik.Reporting.Report
    {
        public ExpRep_FacRegistroFacturacionB()
        {
            /// <summary>
        ...
        private void Rep_FacRegistroFacturacion_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.sqlDataAdapter1.SelectCommand.Parameters["@Ubicacion"].Value = this.ReportParameters["Ubicacion"].Value;
