...
namespace SIANWEB
{
    public partial class CatPosicion : System.Web.UI.Page
    {
        #region Variables
        ...
        private List<Posicion> GetList()
        {
            try
            {
                List<Posicion> List = new List<Posicion>();
                CN_CatPosicion clsCatPosicion = new CN_CatPosicion();
                Posicion posicion = new Posicion();
                posicion.Id_Emp = session.Id_Emp;
                clsCatPosicion.Lista(posicion, session.Emp_Cnx, ref List);
                return List;
            }
            catch (Exception ex)
            {
