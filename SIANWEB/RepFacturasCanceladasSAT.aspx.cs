...
namespace SIANWEB
{
    public partial class RepFacturasCanceladasSAT : System.Web.UI.Page
    {
        #region Variables
        ...
        private void LlenarComboMes()
        {
            Sesion sesion = (Sesion)Session["Sesion" + Session.SessionID];
            CapaNegocios.CN__Comun CN_Comun = new CapaNegocios.CN__Comun();
            CN_Comun.LlenaComboContr(1, sesion.Id_Emp, sesion.Id_Cd_Ver, sesion.Emp_Cnx, "spCatConsulta_Mes_Combo", ref cmbMes);
        ...
        private void Abrir_Reporte(bool a_pantalla)
        {
            ...
            {               
                ...
                ALValorParametrosInternos.Add(sesion.Emp_Nombre );//nombre empresa
                ALValorParametrosInternos.Add(sesion.Cd_Nombre);//nombre sucursal
                ALValorParametrosInternos.Add(sesion.U_Nombre);//usuario
                ALValorParametrosInternos.Add(sesion.Id_Emp);
                ALValorParametrosInternos.Add(sesion.Id_Cd_Ver);
                ALValorParametrosInternos.Add(this.cmbAnio.Text );
                ALValorParametrosInternos.Add(this.cmbMes.SelectedValue);
                ALValorParametrosInternos.Add(cmbAnio.Text);//año
                ALValorParametrosInternos.Add(cmbMes.Text );//mes                 
                  
          
                Type instance = null;
                instance = typeof(LibreriaReportes.RepFacturasSAT);
