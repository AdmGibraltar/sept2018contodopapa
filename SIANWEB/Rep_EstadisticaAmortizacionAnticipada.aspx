    ...
    <telerik:RadAjaxManager ID="RAM1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="txtNumeroCliente">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="cmbTer" UpdatePanelHeight="" />
                    <telerik:AjaxUpdatedControl ControlID="txtRepresentante" UpdatePanelHeight="" />                                      
                </UpdatedControls>
            </telerik:AjaxSetting>
                ...
                <td>
                    ...
                    <table>                        
                        ...
                        <tr>
                            ...
                            <td>                                    
                                <telerik:RadTextBox ID="txtTerritorio" runat="server" Width="125px" MaxLength="5" onpaste="return false">                                        
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Label ID="Label1" runat="server" Text="Unidades/Pesos" />
                            </td>
                            <td>
                                <telerik:RadTextBox ID="txtUnid" runat="server" Width="125px" MaxLength="19" onpaste="return false">
                                    <ClientEvents OnKeyPress="RangoEnterosSeparacionGuionYComas_OnKeyPress" OnBlur="RangoEnterosSeparacionGuionYComas_OnBlur" />
                                </telerik:RadTextBox>
                            </td>
                            <td>
