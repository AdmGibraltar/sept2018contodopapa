            ...
            try
            {
                ...
                else
                {
                    try
                    {
                        ...
                        try
                        {
                            cn_pro.ConsultaProducto(ref producto, sesion.Emp_Cnx, sesion.Id_Emp, sesion.Id_Cd_Ver, sesion.Id_Cd_Ver, Convert.ToInt32(prd_), ValidaInv);
        ...
        private string Producto_Valido(Sesion sesion, string valor_retorno, string gpo_, string ref_, string ter_, string prd_, Producto producto)
        {
            try
            {
                ...
                if (gpo_ == "2")
                {
                    ...
                    else if (Convert.ToInt32(prd_) > 999000000)
                    {
