    ...
    public partial class CatMoneda : System.Web.UI.Page
    {
        ...
        private void DisplayMensajeAlerta(string mensaje)
        {
            if (mensaje.Contains("Page_Load_error"))
                ...
                if (mensaje.Contains("rgTipoMoneda_NeedDataSource"))
                    Alerta("Error al cargar el Grid de tipos de costos");
                else
                    if (mensaje.Contains("rgTipoMoneda_ItemCommand"))
                        ...
                        if (mensaje.Contains("Cmb_CentroDistribucion_IndexChanging_error"))
                            ...
                            if (mensaje.Contains("radGrid_PageIndexChanged"))
                                ...
                                if (mensaje.Contains("PermisoGuardarNo"))
                                    ...
                                    if (mensaje.Contains("CatTipoMonedaIdRepetida_error"))
                                        Alerta("La clave ya existe");
                                    else
                                        if (mensaje.Contains("CatTipoMonedaDescripcionRepetida_error"))
                                            Alerta("La descripción ya existe");
                                        else
                                            if (mensaje.Contains("PermisoModificarNo"))
                                                Alerta("No tiene permisos para actualizar");
                                            else
                                                if (mensaje.Contains("TipoMoneda_insert_ok"))
                                                    Alerta("Los datos se guardaron correctamente");
                                                else
                                                    if (mensaje.Contains("TipoMoneda_insert_error"))
                                                        Alerta("No se pudo guardar los datos del tipo de moneda");
                                                    else
                                                        if (mensaje.Contains("TipoMoneda_update_ok"))
                                                            Alerta("Los datos se modificaron correctamente");
                                                        else
                                                            if (mensaje.Contains("TipoMoneda_update_error"))
