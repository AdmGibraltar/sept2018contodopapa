<%@ Page Title="Reporte de Citas Agendadas" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="Rep_CitasAgendadas.aspx.cs" Inherits="SIANWEB.Rep_CitasAgendadas" %>
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="width: 100px">
                                <asp:Label ID="LblFechaini" runat="server" Text="A Partir de la Fecha" />
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:CheckBox ID="chkAgrupar" runat="server" Text="Agrupar Por Territorio" />
                            </td>
                            <td ></td>
                        </tr> --%>
                    </table>
