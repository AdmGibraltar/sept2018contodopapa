...
namespace SIANWEB
{
    public partial class Rep_PlaneacionContacto : System.Web.UI.Page
    {
        #region Variables
        ...
        private void CargarCombos()
        {
            try
            {
                ...
                this.cmbRSC.Items.Add(new RadComboBoxItem("-- Todos --", "0"));
        ...
        private void Mostrar(bool a_pantalla)
        {
            ...
            rutaServicio.FechaInicial = DateTime.Now;
            rutaServicio.SfechaInicial = DateTime.Now.ToString("dd/MM/yyy");
            ...
            rutaServicio.Orden = Convert.ToInt32(cmbRSC.SelectedValue);
            if (rutaServicio.Orden == 0)
            {
                rutaServicio.Ruta = "Todos";
            }
            else
            {
                rutaServicio.Ruta = cmbRSC.SelectedItem.Text;
            }
            ...
            rutaServicio.Reporte1 = Convert.ToInt32(this.rdbTipoCliente.SelectedValue);

            //if (this.chkClientesA.Checked)
            //    rutaServicio.Reporte1 = 1;
            //if (this.chkClientesB.Checked)
            //    rutaServicio.Reporte1 = 2;
            //if (this.chkClientesC.Checked)
            //    rutaServicio.Reporte1 = 3;
            //if (this.chkClientesD.Checked)
            //    rutaServicio.Reporte1 = 4;
            ...
            if (rutaServicio.Reporte1 == 1)
            {
                strTitulo = "Cliente A  - Rango de Venta: 40,000 o mas";
            }
            if (rutaServicio.Reporte1 == 2)
            {
                strTitulo = "Cliente B  - Rango de Venta: 15,000 a 39,999";
            }
            if (rutaServicio.Reporte1 == 3)
            {
                strTitulo = "Cliente C  - Rango de Venta: 5,000 a 14,999";
            }
            if (rutaServicio.Reporte1 == 4)
            {
                strTitulo = "Cliente D  - Rango de Venta: 0 a 4,999";
            }
            if (rutaServicio.Reporte1 == 5)
            {
                strTitulo = "Cliente Todos";
            } 
            
            ALValorParametrosInternos.Add(strTitulo);
            ...
            ALValorParametrosInternos.Add(rutaServicio.Orden);   //  RSC Id
            ALValorParametrosInternos.Add(rutaServicio.Ruta);   //  RSC
            //conexion
            ...
            if (rutaServicio.Reporte1 == 5)
            {
                ...
                if (a_pantalla)
                {
                    instance = typeof(LibreriaReportes.Rep_RPlaneacionCteTodos);
                }
                else
                {
                    instance = typeof(LibreriaReportes.ExpRep_RPlaneacionCteA);
                }
            }
            else
            {
                ...
                if (a_pantalla)
                {
                    instance = typeof(LibreriaReportes.Rep_RPlaneacionCteA);
                }
                else
                {
                    instance = typeof(LibreriaReportes.ExpRep_RPlaneacionCteA);
            ...
            //    if (a_pantalla)
            //    {
            //        instance = typeof(LibreriaReportes.Rep_RRentasCobradasProd);
            //    }
            //    else
            //    {
            //        instance = typeof(LibreriaReportes.ExpRep_RRentasCobradasProd);
            //    }
            //}
            //if (rutaServicio.Reporte1 == 3)
            //{
