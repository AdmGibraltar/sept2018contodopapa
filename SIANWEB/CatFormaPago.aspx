<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="CatFormaPago.aspx.cs" Inherits="SIANWEB.CatFormaPago" %>
                                ...
                                <telerik:RadGrid ID="rg1" runat="server" AutoGenerateColumns="False" GridLines="None"
                                    ...
                                    <MasterTableView>
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="Id_Fpa" HeaderText="Clave" UniqueName="Id_Fpa">
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                switch (button.get_value()) {
                    case 'new':
                        ...
                        parametros = "Catalogo=CatFormaPago";
                        parametros = parametros + "&sp=spCatCentral_Maximo";
                        parametros = parametros + "&columna=Id_Fpa";
