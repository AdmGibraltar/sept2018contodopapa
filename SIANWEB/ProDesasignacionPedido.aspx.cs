...
namespace SIANWEB
{
    ...
    public partial class ProDesasignacionPedido : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Guardar()
        {
            try
            {
                ...
                cn_desasigna.DesasignaPedido_Aut(session.Id_Emp, session.Id_Cd_Ver, Convert.ToInt32(cmbClientes.SelectedValue), ref verificador, session.Emp_Cnx);
