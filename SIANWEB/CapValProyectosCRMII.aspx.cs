    ...
    public partial class CapValProyectosCRMII : BaseServerPage
    {
        ...
        private void CargarTerritoriosCliente()
        {
            ...
            */
            ...
            lst = cnCatTerritorios.ObtenerTerritorios_PorClienteYRik(Sesion.Id_Emp, Sesion.Id_Cd, (Int32)Id_Cte, CRM_Usuario_Rik, Sesion);
            ...
            try
            {
                ...
                if (this.hiddenId.Value == string.Empty) //nueva valuación de proyecto
                {
                    ...
                    if (valuacionProyecto.ListaProductosValuacionProyecto.Count > 0)
                    {
                        ...
                        var nuevaValuacion = new CN_CapValuacionProyecto().InsertarValuacionProyecto(valuacionProyecto, vp, vpactual, sesion, ObtenerProyectosSeleccionados(), _ibt);
