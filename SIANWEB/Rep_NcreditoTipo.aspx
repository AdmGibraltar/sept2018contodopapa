<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="Rep_NcreditoTipo.aspx.cs" Inherits="SIANWEB.Rep_NcreditoTipo" %>
            ...
            <tr>
                ...
                <td>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="LblTipoR" runat="server" Text="Estatus"></asp:Label>
                            </td>
                            <td colspan="5">
                                <telerik:RadComboBox ID="cmbEstatus" runat="server" Width="130px">
                                    <Items>
                                        <telerik:RadComboBoxItem runat="server" Text="-- Todos --" Value="" />
                                        <telerik:RadComboBoxItem runat="server" Text="Impreso" Value="I" />
                                        <telerik:RadComboBoxItem runat="server" Text="Capturado" Value="C" />
                                        <telerik:RadComboBoxItem runat="server" Text="Baja" Value="B" />
                                    </Items>
                                </telerik:RadComboBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="LblEstatus" runat="server" Text="Tipo de nota"></asp:Label>
                            </td>
                            <td colspan="5">
                                <telerik:RadComboBox ID="cmbTipo" runat="server" Width="300px">
                                </telerik:RadComboBox>
                            </td>
                        </tr>
                        </table>
