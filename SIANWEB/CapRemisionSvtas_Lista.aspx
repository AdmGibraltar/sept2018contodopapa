<%@ Page Title="Relación de Remisions enviadas a revisión o cobro" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="CapRemisionSvtas_Lista.aspx.cs" Inherits="SIANWEB.CapRemisionSvtas_Lista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                switch (button.get_value()) {
                    case 'new':
                        ...
                        AbrirVentana_RemisionRevision(0, 0, 0, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir);
                        break;
                }
            ...
            //--------------------------------------------------------------------------------------------------
            function AbrirVentana_RemisionSvtaAlmacen_Edicion(Id_Emp, Id_Cd, Id_Rva_Editar, estatus) {
                AbrirVentana_RemisionRevision(Id_Emp, Id_Cd, Id_Rva_Editar, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir, estatus);
            }

            //--------------------------------------------------------------------------------------------------
            //Abre la ventana de edición de nota de credito
            //--------------------------------------------------------------------------------------------------
            function AbrirVentana_RemisionRevision(Id_Emp, Id_Cd, Id_Rva, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir, estatus) {
                //debugger;
                var oWnd = radopen("CapRemisionSvtas.aspx?Id_Rva=" + Id_Rva
                    + "&Id_Cd=" + Id_Cd
                    + "&Id_Emp=" + Id_Emp
            ...
            //--------------------------------------------------------------------------------------------------
            // Se ejecuata cuando el radWindow del detalle de Remision se cierra,
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="RAM1">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="rgRemisionSvtaAlmacen" 
            ...
            <telerik:AjaxSetting AjaxControlID="rgRemisionSvtaAlmacen">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgRemisionSvtaAlmacen" 
                        LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
        ...
        <tr>
            ...
            <td>
                ...
                <div style="margin-top: 10px">
                    <telerik:RadGrid ID="rgRemisionSvtaAlmacen" runat="server" AutoGenerateColumns="False" GridLines="None"
                        ...
                        OnNeedDataSource="rgRemisionSvtaAlmacen_NeedDataSource" OnPageIndexChanged="rgRemisionSvtaAlmacen_PageIndexChanged"
                        OnItemCommand="rgRemisionSvtaAlmacen_ItemCommand" OnItemDataBound="rgRemisionSvtaAlmacen_ItemDataBound">
                        <SortingSettings SortedAscToolTip="Orden acendente" SortedDescToolTip="Orden decendente"
                            SortToolTip="Clic para reordenar" />
                        <ExportSettings IgnorePaging="true" OpenInNewWindow="true" FileName="Lista_Remisions_Svta_Almacen"
                            HideStructureColumns="true" ExportOnlyData="true">
                            <Pdf PageHeight="210mm" PageWidth="297mm" PageTitle="Lista_Remisions_Svta" Title="Lista_Remisions_Svta" />
                        </ExportSettings>
                        <MasterTableView DataKeyNames="Id_Emp,Id_Cd,Id_Rva" ClientDataKeyNames="Id_Rva" CommandItemDisplay="none"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="Id_Rva" HeaderText="Folio" UniqueName="Id_Rva">
                                    <ItemStyle HorizontalAlign="Right" />
                                    <HeaderStyle Width="70px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Rva_Estatus" HeaderText="Rva_Estatus" UniqueName="Rva_Estatus"
                                    Display="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="80px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Rva_EstatusStr" HeaderText="Estatus" UniqueName="Rva_EstatusStr">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="80px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Rva_Fecha" HeaderText="Fecha" UniqueName="Rva_Fecha"
                                    DataFormatString="{0:dd/MM/yyyy}">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle Width="90px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Rva_Entrego" HeaderText="Entregó" UniqueName="Rva_Entrego">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="200px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Rva_Recibio" HeaderText="Recibió" UniqueName="Rva_Recibio">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="200px" />
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridButtonColumn CommandName="Eliminar" HeaderText="Baja" ConfirmDialogType="RadWindow"
                                    ConfirmDialogHeight="150px" ConfirmDialogWidth="350px" ConfirmText="¿Está seguro de dar de baja la relación de Remisions enviadas de Servicio de Ventas a Almacen?"
                                ...
                                <telerik:GridButtonColumn CommandName="Imprimir" HeaderText="Imprimir" ConfirmDialogType="RadWindow"
                                    ConfirmDialogHeight="150px" ConfirmDialogWidth="350px" ConfirmText="Se imprimirá la relación de Remisions enviadas de Servicio de Ventas a Almacen, tenga listo el formato en la impresora"
