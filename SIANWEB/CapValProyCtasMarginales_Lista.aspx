...
AutoEventWireup="true" CodeBehind="CapValProyCtasMarginales_Lista.aspx.cs" Inherits="SIANWEB.CapValProyCtasMarginales_Lista" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function AbrirVentana_ValProyecto(Id_Emp, Id_Cd, Id_Vap, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir, modificable) {
                //debugger;
                var oWnd = radopen("CapValProyCtasMarginales.aspx?Id_Vap=" + Id_Vap
                    + "&Id_Cd=" + Id_Cd
                    + "&Id_Emp=" + Id_Emp
                    ...
                    <div id="formulario" runat="server">
                        ...
                        <table>
                            <tr>
                               ...
                               <%-- <td>
                                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Img/find16.png" OnClick="btnBuscar_Click"
                        ...
                        <table>
                            <tr>
                                <%--<td width="115">
                                    <asp:Label ID="Label8" runat="server" Text="Estatus" Visible="false"></asp:Label>
                                </td>
                                <td>
                                    <telerik:RadComboBox ID="cmbEstatus" runat="server" Visible="false">
                                        <Items>
                                ...
                                <telerik:RadGrid ID="rgBase" runat="server" AutoGenerateColumns="False" GridLines="None"
                                    ...
                                    <MasterTableView DataKeyNames="Id_Emp,Id_Cd,Id_Vap" CommandItemDisplay="none" PageSize="15">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="Vap_Estatus" HeaderText="Estatus" Display="false"
