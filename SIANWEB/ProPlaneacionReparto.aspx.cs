    ...
    public partial class ProPlaneacionReparto : System.Web.UI.Page
    {
            ...
            try
            {
                if (Convert.ToBoolean(HF_Guardar.Value))
                {
                    ...
                    for (int x = 0; x < rgPedido.Items.Count; x++)
                    {
                        ...
                        {
                            if (Ped_Det.Prd_Faltante == 0)
                            {
                                list.Clear();
                                Alerta("No se realizó la asignación. Algunos de los productos seleccionados son invalidos.");
                                break;
                            }
                            else
                            {
        ...
        private void Inicializar()
        {
            try
            {
                ...
                txtRuta.Text = Request.QueryString["Ruta"].ToString();
                txtSector.Text = Request.QueryString["Sector"].ToString();
