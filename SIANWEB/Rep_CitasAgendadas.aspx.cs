...
namespace SIANWEB
{
    public partial class Rep_CitasAgendadas : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Mostrar(bool a_pantalla)
        {
            ...
            //if (rutaServicio.Orden + rutaServicio.Reporte1 == 0)
            //{
            //    ALValorParametrosInternos.Add("Sin Agrupar");
            //}
            //else
            //{
            //    if (rutaServicio.Orden + rutaServicio.Reporte1 == 1)
            //    {
            //        ALValorParametrosInternos.Add("Con Detalle");
            //    }
            //    else
            //    {
            //        if (rutaServicio.Orden + rutaServicio.Reporte1 == 10)
            //        {
            //            ALValorParametrosInternos.Add("Agrupado");
            //        }
            //        else
            //        {
            //            ALValorParametrosInternos.Add("Agrupado Con Detalle");
            //        }
            //    }
            //}
            ...
            //ALValorParametrosInternos.Add(rutaServicio.Orden + rutaServicio.Reporte1);   //  Tipo
            ...
            if (a_pantalla)
                {
                    instance = typeof(LibreriaReportes.Rep_RCitasAgendadas);
                }
                else
                {
                    instance = typeof(LibreriaReportes.ExpRep_RCitasAgendadas);
                }
