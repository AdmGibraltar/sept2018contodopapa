<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="CatSolucion.aspx.cs" Inherits="SIANWEB.CatSolucion" %>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbArea" runat="server" OnClientSelectedIndexChanged="cmb3_ClientSelectedIndexChanged"
                                    ...
                                    DataTextField="Descripcion" DataValueField="Id" Width="250px" EnableLoadOnDemand="true"
                                    HighlightTemplatedItems="true" LoadingMessage="Cargando..." 
                                    OnClientBlur="Combo_ClientBlur" EmptyMessage="Seleccione un segmento">
                                    <ItemTemplate>
                                        <table>
                                            <tr>
                                                <td style="width: 50px; text-align: center">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <telerik:RadNumericTextBox ID="txtPotencial" runat="server" MinValue="0" 
                                    MaxLength="4" Width="70px">
                            ...
                            <td>
                                <telerik:RadGrid ID="rg1" runat="server" AutoGenerateColumns="False" GridLines="None"
                                    ...
                                    <MasterTableView NoMasterRecordsText="No se encontraron registros.">
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="Id_Sol" HeaderText="Clave" UniqueName="Id_Sol">
                                            ...
                                            <telerik:GridBoundColumn DataField="Sol_Descripcion" HeaderText="Descripción" UniqueName="Sol_Descripcion">
                                            ...
                                            <telerik:GridBoundColumn DataField="Sol_Potencial" HeaderText="Potencial (%)" UniqueName="Sol_Potencial"
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                switch (button.get_value()) {
                    case 'new':
                        ...
                        parametros = "Catalogo=CatSolucion";
                        parametros = parametros + "&sp=spCatCentral_Maximo";
                        parametros = parametros + "&columna=Id_Sol";
