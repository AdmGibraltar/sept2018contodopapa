                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li <%=(int)Session["activeMenu"]==4?"class=\"active\"":"" %>><a href="../GestionPromocion/Proyectos_TablaAgrupada.aspx">
                                   ...
                                   <%-- <li <%=(int)Session["activeMenu"]==7?"class=\"active\"":"" %>><a href="../GestionPromocion/Reportes/DINAMO/ReporteDINAMOFull.aspx">
                                    ...
                                    <li <%=(int)Session["activeMenu"]==7?"class=\"active\"":"" %>><a href="../GestionPromocion/ReporteDinamo.aspx">
                                        <i class="fa fa-book"></i>Reporte DINAMO</a>
                                    </li>
