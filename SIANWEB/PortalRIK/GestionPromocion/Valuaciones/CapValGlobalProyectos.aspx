<%@ Page Title="Valuación de proyectos" Language="C#" MasterPageFile="~/MasterPage/MasterPage02.master"
    AutoEventWireup="true" CodeBehind="CapValGlobalProyectos.aspx.cs" Inherits="SIANWEB.PortalRIK.GestionPromocion.Valuaciones.CapValGlobalProyectos" %>
                    ...
                    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" BorderStyle="Solid"
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:ImageButton ID="imgBuscar" Visible="false" runat="server" ImageUrl="~/Img/find16.png" OnClick="imgAceptar_Click"
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <asp:Label ID="Label4" Visible="false" runat="server" Text="Nota"></asp:Label>
                                        </td>
                                        <td colspan="4">
                                            <telerik:RadTextBox ID="txtNota" Visible="false" runat="server" Rows="4" TextMode="MultiLine" MaxLength="250"
                                                Width="377px">
                                                <ClientEvents OnFocus="_PreValidarFechaEnPeriodo" />
                                            </telerik:RadTextBox>
                                        </td>
                        ...
                        <telerik:RadPageView ID="RadPageViewProyectos" runat="server" heigth="480px">
                         <telerik:RadSplitter ID="RadSplitterProyectos" runat="server" Height="480px" ResizeMode="AdjacentPane"
                                ...
                                <asp:CheckBox runat="server" ID="chkIncluirVentaTrimestral" Text="Incluir Venta Trimestral" />
                             </telerik:RadPane>
                         </telerik:RadSplitter>
                        </telerik:RadPageView>
