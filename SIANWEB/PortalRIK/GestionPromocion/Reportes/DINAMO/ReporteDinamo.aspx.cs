...
namespace SIANWEB.PortalRIK.GestionPromocion.Reportes.DINAMO
{
    public partial class ReporteDinamo : BaseServerPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            mp.CurrentPath = new List<string>() { "Gestion de la Promoción", "Reporte DINAMO" }.ToArray();
        ...
        public void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            {
                ibSianCentral.Begin();
                int iCDC = rbCDC.Checked ? 2 : 1;
                var fuente = cnReporteDINAMO.GenerarVistaGeneral( this.EntidadSesion, iCDC, anyo, mes, chkPromedioTresMeses.Checked, ibSianCentral);
                //var fuente = cnReporteDINAMO.Generar_VistaGeneral(this.EntidadSesion, iCDC, anyo, mes, chkPromedioTresMeses.Checked, ibSianCentral);
        ...
        public void lnkbtnRikNombre_Click(object sender, EventArgs e)
        {
            using (IBusinessTransaction ibSianCentral = CN_FabricaTransaccionNegocios.ParaSIANCentral(EntidadSesion))
            {
                ...
                CN_ReporteDINAMO cnReporteDINAMO = new CN_ReporteDINAMO();
                var fuente = cnReporteDINAMO.GenerarVistaProyectos(EntidadSesion, anyo, mes, ViewModel.IdCdElegido.Value, idRik, chkPromedioTresMeses.Checked, ibSianCentral);
