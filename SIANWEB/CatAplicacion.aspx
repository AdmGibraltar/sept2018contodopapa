<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="CatAplicacion.aspx.cs" Inherits="SIANWEB.CatAplicacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadAjaxManager ID="RAM1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="cmbSolucion">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="divPrincipal" LoadingPanelID="RadAjaxLoadingPanel1"
                        UpdatePanelHeight="" />
                </UpdatedControls>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <telerik:RadTextBox onpaste="return false" ID="txtDescripcion" runat="server" Width="320px">
                                </telerik:RadTextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtUen"
                                    Display="Dynamic" ErrorMessage="*Requerido" ForeColor="Red" ValidationGroup="Guardar"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtSegmento" runat="server" Width="70px" MaxLength="9"
                                    MinValue="1">
                                    <NumberFormat DecimalDigits="0" GroupSeparator="" />
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbSegmento" runat="server" OnClientSelectedIndexChanged="cmb2_ClientSelectedIndexChanged"
                                    ...
                                    DataTextField="Descripcion" DataValueField="Id" Width="250px" EnableLoadOnDemand="true"
                                    HighlightTemplatedItems="true" LoadingMessage="Cargando..." OnClientBlur="Combo_ClientBlur"
                                    EmptyMessage="Seleccione una uen" OnSelectedIndexChanged="cmbSegmento_SelectedIndexChanged"
                                    AutoPostBack="True">
                                    <ItemTemplate>
                                        <table>
                                            <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtSegmento"
                                    Display="Dynamic" ErrorMessage="*Requerido" ForeColor="Red" ValidationGroup="Guardar"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtArea" runat="server" Width="70px" MaxLength="9"
                                    MinValue="1">
                                    <NumberFormat DecimalDigits="0" GroupSeparator="" />
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbArea" runat="server" OnClientSelectedIndexChanged="cmb3_ClientSelectedIndexChanged"
                                    Filter="Contains" ChangeTextOnKeyBoardNavigation="true" MarkFirstMatch="true"
                                    DataTextField="Descripcion" DataValueField="Id" Width="250px" EnableLoadOnDemand="true"
                                    HighlightTemplatedItems="true" LoadingMessage="Cargando..." OnClientBlur="Combo_ClientBlur"
                                    EmptyMessage="Seleccione un segmento" AutoPostBack="True" 
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label8" runat="server" Text="Solución"></asp:Label>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtSolucion" runat="server" Width="70px" MaxLength="9"
                                    MinValue="1">
                                    <NumberFormat DecimalDigits="0" GroupSeparator="" />
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbSolucion" runat="server" OnClientSelectedIndexChanged="cmb4_ClientSelectedIndexChanged"
                                    ...
                                    DataTextField="Descripcion" DataValueField="Id" Width="250px" EnableLoadOnDemand="true"
                                    HighlightTemplatedItems="true" LoadingMessage="Cargando..." OnClientBlur="Combo_ClientBlur"
                                    EmptyMessage="Seleccione una área">
                                    <ItemTemplate>
                                        <table>
                                            <tr>
                                                <td style="width: 50px; text-align: center">
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtSolucion"
                                    Display="Dynamic" ErrorMessage="*Requerido" ForeColor="Red" ValidationGroup="Guardar"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2">
                                <telerik:RadNumericTextBox ID="txtPotencial" runat="server" MinValue="0" MaxLength="4"
                                    Width="70px">
                                    <NumberFormat PositivePattern="n %" />
                                </telerik:RadNumericTextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtPotencial"
                                    Display="Dynamic" ErrorMessage="*Requerido" ForeColor="Red" ValidationGroup="Guardar"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                &nbsp;
                        ...
                        <tr>
                            <td>
                                &nbsp;</td>
                            <td colspan="2">
                                <asp:CheckBox ID="chkLimpieza" runat="server" Text="Limpieza" />
                            </td>
                            <td>
                                &nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="chkActivo" runat="server" Text="Activo" Checked="True" AutoPostBack="True"
                            ...
                            <td>
                                <telerik:RadGrid ID="rg1" runat="server" AutoGenerateColumns="False" GridLines="None"
                                    ...
                                    <MasterTableView NoMasterRecordsText="No se encontraron registros.">
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="Id_Apl" HeaderText="Clave" UniqueName="Id_Apl">
                                                <HeaderStyle Width="70px" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Id_Sol" HeaderText="Solución" UniqueName="Id_Sol">
                                                <HeaderStyle Width="70px" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Id_Area" HeaderText="Area" UniqueName="Id_Area"
                                                Display="false">
                                                <HeaderStyle Width="70px" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Apl_Descripcion" HeaderText="Descripción" UniqueName="Apl_Descripcion">
                                                <HeaderStyle Width="300px" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Id_Seg" HeaderText="Segmento" UniqueName="Id_Seg"
                                                Display="false">
                                                <HeaderStyle Width="70px" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Id_Uen" HeaderText="Uen" UniqueName="Id_Uen"
                                                Display="false">
                                                <HeaderStyle Width="70px" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Apl_Potencial" HeaderText="Potencial (%)" UniqueName="Apl_Potencial"
                                                DataFormatString="{0:N2}">
                                                <HeaderStyle Width="90px" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Apl_Limpieza" HeaderText="Limpieza" UniqueName="Apl_Limpieza"
                                                 >
                                            </telerik:GridBoundColumn>
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                switch (button.get_value()) {
                    case 'new':
                        ...
                        parametros = "Catalogo=CatAplicacion";
                        parametros = parametros + "&sp=spCatCentral_Maximo";
                        parametros = parametros + "&columna=Id_Apl";
