...
{
    public partial class Rep_ProgramaReparto : Telerik.Reporting.Report
    {
        public Rep_ProgramaReparto()
        {
            InitializeComponent();
        }

        public Rep_ProgramaReparto(IContainer container)
        {
            container.Add(this);
        ...
        private void Rep_ProgramaReparto_NeedDataSource(object sender, EventArgs e)
        {
