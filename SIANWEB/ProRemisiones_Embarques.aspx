<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="ProRemisiones_Embarques.aspx.cs" Inherits="SIANWEB.ProRemisiones_Embarques" %>
        ...
        <table style="font-family: Verdana; font-size: 8pt">
            <tr>
                ...
                <td>
                    ...
                    <!-- <asp:Panel ID="Panel1" runat="server" Width="950px" ScrollBars="Horizontal">-->
                        ...
                        <MasterTableView ClientDataKeyNames="Id_Rem">
                            ...
                            <Columns>
                                ...
                                <telerik:GridButtonColumn CommandName="Autorizar" HeaderText="Autorizar" ConfirmDialogType="RadWindow"
                                    ConfirmText="¿Desea autorizar la remisión <b>#[[ID]]</b> ? <br />" Text="Autorizar"
