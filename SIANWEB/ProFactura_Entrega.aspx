<%@ Page Title="Facturas en entrega" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="ProFactura_Entrega.aspx.cs" Inherits="SIANWEB.ProFactura_Entrega" %>
                ...
                <td>
                    ...
                    <asp:Panel ID="Panel1" runat="server" Width="950px">
                        <telerik:RadGrid ID="rgFactura" runat="server" AutoGenerateColumns="False" Width="900px"
                            ...
                            <MasterTableView ClientDataKeyNames="Numero">
                                <RowIndicatorColumn>
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="Id_Fac" HeaderText="Factura" UniqueName="Numero">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    ...
                                    <telerik:GridButtonColumn CommandName="Autorizar" HeaderText="Entregada" ConfirmDialogType="RadWindow"
                                        ConfirmText="¿Desea confirmar la entrega de la factura <b>#[[ID]]</b> ? <br />"
                                        Text="Autorizar entrega" ConfirmDialogHeight="150px" ConfirmDialogWidth="350px"
