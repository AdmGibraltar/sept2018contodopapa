    ...
    public partial class Ventana_Autorizacion : System.Web.UI.Page
    {
        ...
        private void Entrar(Usuario usuario)
        {
            try
            {
                ...
                List<int> CDIS = new List<int> {110, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 310, 340, 350, 360,370, 380, 390, 400, 410, 430, 510, 610, 620, 640};
                ...
                if (Id == 1)
                {
                    ...
                    if (usuario.Cu_Estatus == true)
                    {
                        ...
                        if (!Session["Sesion" + Session.SessionID + "Id_Tu"].ToString().Contains("," + usuario.Id_TU.ToString() + ",") && CDI != 0)
                        {
