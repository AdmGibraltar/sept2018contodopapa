<%@ Page Title="Notas de cargos" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="Notas.aspx.cs" Inherits="SIANWEB.Notas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                switch (button.get_value()) {
                    case 'new':
                        ...
                        AbrirVentana_NotaCargo(0, 0, 0, '1', permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir);
                        break;
                }
            ...
            //--------------------------------------------------------------------------------------------------
            function AbrirVentana_NotaCargo_Edicion(Id_Emp, Id_Cd, Id_Nca_Editar, notaModificable) {
                AbrirVentana_NotaCargo(Id_Emp, Id_Cd, Id_Nca_Editar, notaModificable, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir);
            }

            //--------------------------------------------------------------------------------------------------
            //Abre la ventana de edición de factura
            //--------------------------------------------------------------------------------------------------
            function AbrirVentana_NotaCargo(Id_Emp, Id_Cd, Id_Nca, notaModificable, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir) {
                //debugger;
                var oWnd = radopen("Notas2.aspx?Id_Nca=" + Id_Nca
                    + "&Id_Cd=" + Id_Cd
                    + "&Id_Emp=" + Id_Emp
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="RAM1">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="rgNotaCargo" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
