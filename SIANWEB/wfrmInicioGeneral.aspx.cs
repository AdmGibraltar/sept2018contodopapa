...
namespace SIANWEB
{
    public partial class wfrmInicioGeneral : System.Web.UI.Page
    {
        #region Variables
            ...
            try
            {
                if (session != null)
                {
                    if (this.ddlMeses.SelectedIndex == -1 || this.ddlMeses.SelectedIndex == 0)
                    {
                        ...
                        return InfoSoftGlobal.FusionCharts.RenderChartHTML("FusionCharts/Column3D.swf", "", xmlData.ToString(), "myNext", "500", "300", false);
                    }
                    else
                    {
            ...
            try
            {
                if (session != null)
                {
                    ...
                    if (dsGraficaActividad != null)
                    {
                        ...
                        xmlData.Append("</chart>");
                        return InfoSoftGlobal.FusionCharts.RenderChartHTML("FusionCharts/StackedColumn3D.swf", "", xmlData.ToString(), "myNext", "300", "300", false);
                    }
                    else
                        return "";
                }
