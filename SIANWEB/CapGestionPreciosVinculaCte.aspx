<%@ Page Title="Gestión precios" Language="C#" MasterPageFile="~/MasterPage/MasterPage03.master"
    AutoEventWireup="true" CodeBehind="CapGestionPreciosVinculaCte.aspx.cs" Inherits="SIANWEB.CapGestionPreciosVinculaCte" %>
                    ...
                    <table>
                     <tr>
                      ...
                      <tr>
                            ...
                            <td class="style1">
                                <asp:Label runat ="Server" ID="Lbl2" Text="No. Convenio" Font-Bold="True">
                                </asp:Label>
                              </td>
                            ...
                            <td>
                                &nbsp;</td>
                            <td>
                                    <asp:Label runat ="Server" ID="Label1" Text="Nombre" Font-Bold="True">
                                </asp:Label></td>
                                  <td  width="50%">
                                      &nbsp;</td>
                        </tr>
