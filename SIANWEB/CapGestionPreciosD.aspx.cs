    ...
    public partial class CapGestionPreciosD : System.Web.UI.Page
    {
        ...
        private void CargarUsuarios()
        {
            try
            {
                ...
                CN__Comun cn_comun = new CN__Comun();
                cn_comun.LlenaCombo(100 , 1, 1, Conexion, "spCatUsuario_Combo", ref CmbId_ULider);
                cn_comun.LlenaCombo(100, 1, 1, Conexion, "spCatUsuario_Combo", ref CmbId_UEjecutivo);
            ...
            try
            {
                ...
                if (Verificador == -1)
                {
                    ...
                    if (int.Parse(HFTipoOp.Value) == 0)
                    {
                        ...
                        cn_conv.ConvenioCreo_EnviarCorreo(Id_PC, Conexion2);
                    ...
                    else
                    {
                        ...
                        cn_conv.ConvenioSustituyo_EnviarCorreo(Id_PC, Conexion2);
            ...
            try
            {
                ...
                if (Verificador == -1)
                {
                    ...
                    if (Verificador == -1)
                    {
                        ...
                        cn_conv.ConvenioModifico_EnviarCorreo(int.Parse(HFId_PC.Value), Conexion2);
