...
namespace CapaEntidad
{
    public class  TransferenciaAlmacen
    {
        ...
        private List<TransferenciaAlmacenDet> _listTransferenciaAlmacen;
        public List<TransferenciaAlmacenDet> ListTransferenciaAlmacen
        {
            get { return _listTransferenciaAlmacen; }
            set { _listTransferenciaAlmacen = value; }
        }
