...
namespace CapaDatos
{
    public class CD_CatCentroDistribucion
    {
        ...
        public void Consulta_Centro_DistribucionCombo(int Id1, int Id2, int Id3, int Id4, ref List<CrmLista> list, string Conexion)
        {
            try
            {
                ...
                object[] Valores = { Id1, Id2, Id3, Id4, 0 };

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCat_ConsultaCentroDistribucionCombo", ref dr, Parametros, Valores);

                while (dr.Read())
                {
                    var objCD = new CrmLista();
                    objCD.Id = dr.GetInt32(dr.GetOrdinal("Id"));
                    objCD.Descripcion = dr.GetString(dr.GetOrdinal("Descripcion"));
                    list.Add(objCD);
                }
                dr.Close();
        ...
        public void ConsultaCentroDistribucionCombo(int Id1, int Id2, int Id3, int Id4, ref List<CrmLista> list, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        /// </summary>
        /// <param name="centroDistribucion"></param>
        /// <param name="Id_Cd"></param>
        /// <param name="Id_Emp"></param>
        /// <param name="icdCtx">Contexto de conexión a la fuente de datos</param>
        public void ConsultaCentroDistribucion(ref CentroDistribucion centroDistribucion, int Id_Cd, int Id_Emp, ICD_Contexto icdCtx)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                SqlCommand sqlcmd = CD_Datos.GenerarSqlCommand("spCatCentroDistribucion_Consulta", ref dr, Parametros, Valores, icdCtx);
                ...
                while (dr.Read())
                {
                    ...
                    centroDistribucion.Cd_MargenDiferenciaDocs = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Cd_MargenDiferenciaDocs"))) ? 0 : Convert.ToDouble(dr.GetValue(dr.GetOrdinal("Cd_MargenDiferenciaDocs")));
                    ...
                    {
                        centroDistribucion.Cd_FactorCostoFinanciero = 0;
                    }

                    centroDistribucion.CD_Gasto = dr["CD_Gasto"].ToString() == "" ? (Double?)null : Convert.ToDouble(dr["CD_Gasto"]);
                    centroDistribucion.CD_NuevoEsquemaCom = Convert.ToBoolean(dr["CD_NuevoEsquemaCom"]);

                    //Edsg28062017
                    centroDistribucion.CD_PermiteTerrMismaUEN = Convert.ToBoolean(dr["CD_PermiteTerrMismaUEN"]);
        ...
        public void GuardarCentroDistribucion(ref CentroDistribucion centroDistribucion, string Conexion, ref int verificador, bool actualizar)
        {
            ...
            try
            {
                ...
                string[] Parametros = {
                    ...
                    ,"@Cd_Gasto"
                    ,"@Cd_NuevoEsquemaCom"
					,"@Cd_MargenDiferenciaDocs"
                     //Edsg26062017
                    ,"@CD_PermiteTerrMismaUEN"
		        };
                ...
                object[] Valores = {
                    ...
                    ,centroDistribucion.CD_Gasto 
                    ,centroDistribucion.CD_NuevoEsquemaCom
					,centroDistribucion.Cd_MargenDiferenciaDocs,

                    //Edsg26062017
                    centroDistribucion.CD_PermiteTerrMismaUEN
		        };
        ...
        public void ConsultaCentrosPropios(ref List<CentroDistribucion> list, int Id_Emp, string Conexion)
        {
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatCentrosLista_Consultar", ref dr, Parametros, Valores);
                CentroDistribucion centroDistribucion = new CentroDistribucion();
                while (dr.Read())
                {
                    centroDistribucion = new CentroDistribucion();
                    centroDistribucion.Cd_Descripcion = dr.GetValue(dr.GetOrdinal("Nombre")).ToString();
                    centroDistribucion.Id_Cd = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cd")));
                    list.Add(centroDistribucion);
                }
        ...
        public Boolean ValidarVariasUEN(int Id_Emp, int Id_Cd, int Id_Cte, string Conexion)
        {
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatClientesVariasUEN", ref dr, Parametros, Valores);
        ...
        /// <summary>
        /// Devuelve el resultado de la consulta al repositorio CatCentroDistribucion
        /// </summary>
        /// <param name="idEmp">Identificador de la empresa</param>
        /// <param name="idCd">Identificador del centro de distribución</param>
        /// <param name="icdCtx">Contexto de conexión a la fuente de datos</param>
        /// <returns>CatCentroDistribucion</returns>
        public CatCentroDistribucion Consultar(int idEmp, int idCd, ICD_Contexto icdCtx)
        {
            sianwebmty_gEntities ctx = ((ICD_Contexto<sianwebmty_gEntities>)icdCtx).Contexto;
            var resultados = from cd in ctx.CatCentroDistribucions
                             where cd.Id_Emp == idEmp && cd.Id_Cd == idCd
                             select cd;
