...
namespace CapaDatos
{
    public class CD_Datos 
    {
        ...
        public SqlCommand GenerarSqlCommand(string query, ref DataSet ds)
        {
            SqlCommand functionReturnValue = default(SqlCommand);
            try
            {
                functionReturnValue = new SqlCommand(query, sqlcnx);
                functionReturnValue.CommandType = CommandType.Text;
